...
namespace Ultima
{
	...
	{
		private static FileIndex m_FileIndex = new FileIndex("Gumpidx.mul", "Gumpart.mul", 0xFFFF, 12, ".tga", -1, true);
		...
		public static void Reload()
		{
			try
			{
				m_FileIndex = new FileIndex("Gumpidx.mul", "Gumpart.mul", 12, -1, ".tga", -1, true);
				m_Cache = new Bitmap[m_FileIndex.Index.Length];
				m_Removed = new bool[m_FileIndex.Index.Length];
			}
			catch
