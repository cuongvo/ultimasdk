...
namespace Ultima
{
	...
	{
		private static FileIndex m_FileIndex = new FileIndex("Artidx.mul", "Art.mul", 0x10000/*0x13FDC*/, 4, ".tga", 0x13FDC, false);
		...
		{
			m_FileIndex = new FileIndex("Artidx.mul", "Art.mul", 0x10000/*0x13FDC*/, 4, ".tga", 0x13FDC, false);
			m_Cache = new Bitmap[GetIdxLength()];
			m_Removed = new bool[GetIdxLength()];
			m_patched.Clear();
			Modified = false;
